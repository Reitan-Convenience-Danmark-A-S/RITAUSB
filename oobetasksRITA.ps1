...
Start-Process PowerShell -ArgumentList "-NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/Reitan-Convenience-Danmark-A-S/RITAUSB/refs/heads/main/AddAutopilotDeviceRITA.ps1" -Wait
